<template>
    ...
    <!-- <div v-if="isAuthenticated" id="Main" class="xl:rounded-r transform xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 flex-col">
        <template> -->

<div
v-if="isAuthenticated" 
    id="Main"
    class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start  w-full sm:w-64  flex-col"
>
    ...
    <div
        ...
        <button
            class="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-indigo-400  text-black rounded "
        >
            <svg
                class="fill-stroke "
                width="24"
    ...
    <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
        ...
        >
            <button
                class="flex justify-start items-center space-x-6 hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52"
            >
                <q-icon
        ...
        class="flex justify-start items-center space-x-6 hover:text-black focus:bg-gray-700 focus:text-black hover:bg-gray-700 text-gray-400 rounded px-3 py-2 w-full md:w-52"
    >
     <q-icon class="ml-1" name="logout" color="black" size="20px" icon label="Logout" />
        <p class="text-base mt-2 leading-4">Logout</p>
    </button>
        </div>
    </div>
    <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
        <button
            ...
            class="focus:outline-none focus:text-indigo-400  text-black flex justify-between items-center w-full py-5 space-x-14  "
        >
        ...
        <div class="hidden flex justify-start flex-col items-start pb-5 ">
            ...
            <button
                class="flex justify-start items-center space-x-6 hover:text-black focus:bg-gray-700 focus:balck-black hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52"
            >
                <svg
                    width="24"
                    height="24"
