<template>
 ...
 <div v-if="drawer"  id="Main" class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start  w-full sm:w-64  flex-col">
  ...
  <div class="hidden xl:flex justify-start p-6 items-center space-x-3">
    ...
    <p class="text-2xl leading-6 text-black">OvonRueden</p>
  </div>
  ...
  <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
    <button onclick="showMenu1(true)" class="focus:outline-none focus:text-indigo-400 text-left  text-black flex justify-between items-center w-full py-5 space-x-14  ">
    ...
    <div id="menu1" class="flex justify-start  flex-col w-full md:w-auto items-start pb-1 ">
      <button class="flex justify-start items-center space-x-6 hover:text-black focus:bg-gray-700 focus:text-black hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
        <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <button class="flex justify-start items-center space-x-6 hover:text-black focus:bg-gray-700 focus:text-mblack hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
    <button onclick="showMenu2(true)" class="focus:outline-none focus:text-indigo-400  text-black flex justify-between items-center w-full py-5 space-x-14  ">
    ...
    <div class="hidden flex justify-start flex-col items-start pb-5 ">
      ...
      <button class="flex justify-start items-center space-x-6 hover:text-black focus:bg-gray-700 focus:balck-black hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="flex flex-col justify-between items-center h-full pb-6   px-6  w-full  space-y-32 ">
    <button onclick="showMenu3(true)" class="focus:outline-none focus:text-indigo-400  text-black flex justify-between items-center w-full py-5 space-x-14  ">
    ...
    <div class="hidden flex justify-start flex-col items-start pb-5 ">
      <button class="flex justify-start items-center space-x-6 hover:text-black focus:bg-gray-700 focus:text-black hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-52">
        <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M15 10L11 14L17 20L21 4L3 11L7 13L9 19L12 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <router-link   to="/plans">plans</router-link>
    ...
    <div class=" flex justify-between items-center w-full">
      <div class="flex justify-center items-center  space-x-2">
        ...
        <div class="flex justify-start flex-col items-start">
          <p class="cursor-pointer text-sm leading-5 text-black">Alexis Enache</p>
...
// Watch for changes in the `drawer` prop to keep `localDrawer` in sync
watch(
  () => props.drawer,
  (newVal) => {
...
// You can toggle the local state if needed
